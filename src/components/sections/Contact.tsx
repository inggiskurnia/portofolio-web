          ...
          >
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4 pt-4">
                  <a
                    ...
                    target="_blank"
                    className="p-3 bg-card border border-border rounded-lg text-muted-foreground hover:text-primary hover:border-primary transition-all hover:-translate-y-1"
                  >
                    <Github size={24} />
                  </a>
                  <a
            ...
            <div className="bg-gradient-to-br from-primary to-blue-600 p-8 rounded-2xl shadow-lg text-white">
              ...
              <p className="opacity-90 leading-relaxed">
                I am currently available for freelance projects and full-time opportunities. If you
                need a dedicated developer to bring your ideas to life, let&apos;s talk!
              </p>
            </div>
          </motion.div>
