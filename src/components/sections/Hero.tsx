    ...
    <section className="relative bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 md:py-48">
        <div className="max-w-3xl">
          <div className="mb-6">
            <span className="text-3xl md:text-6xl font-bold">Hi👋, I&#39;m Inggis Trisiawan</span>
          </div>
          <h2 className="text-2xl md:text-3xl font-medium mb-6 text-gray-600">Software Engineer</h2>
          <p className="text-lg mb-8 text-gray-700 leading-relaxed">
            Aspiring software engineer and passionate about building scalable applications with
            modern technologies
          </p>
